...
export default function Scrumboard() {
  const { fullName, projectType, projectName } = useStateContext();
  ...
  return (
    <>
      <div className={modalIsOpen ? "overlay" : null}></div>
      ...
      <div className="scrumboard-container">
        <div className="user-welcome">
          ...
          <div className="scrumboard-body">
            <p className="intro">
              {" "}
              Break your project into smaller{" "}
              <span className="weekly_intro"> weekly </span> and{" "}
              <span className="daily_intro"> daily </span> tasks to help you
              achieve them, faster!
            </p>
          </div>
        </div>
        ...
        <div className="tasks">
          <Tasks weeklyTask={weeklyTask} setWeeklyTask={setWeeklyTask} />
        </div>
